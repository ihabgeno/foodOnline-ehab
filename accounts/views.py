...
#Restrict the customer form accessing the vendor
...
def registerUser(request):
    if request.user.is_authenticated :
        ...
        if form.is_valid():
            ...
            messages.success(request, 'Your account has been register sucessfuly')
            #messages.error(request, 'Your account has been register sucessfuly')
